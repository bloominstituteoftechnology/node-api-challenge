...
* An **array of functions** that extend Express's features. The functions can get the request and response objects, operate on them, or trigger actions as desired. Some uses include logging and security.

- [x] Describe a Resource.

* Any piece of data: an object, image, string of text, sound file, etc.

- [x] What can the API return to help clients know if a request was successful?

* **Status codes** sent in the header are used for this. They fall into 5 general categories: 1xx = informational, 2xx = success, 3xx = redirection, 4xx = client error, and 5xx = server error. My favorite is 418.

- [x] How can we partition our application into sub-applications?

* By using **routing** to allow different parts of the application (function handlers) to handle different portions of the URI.
