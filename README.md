...
- [X] Describe Middleware?
        ...
        Middleware is code that obtains code by intercepting it and performs functions and may modify the response as well.

- [X] Describe a Resource?

        An endpoint on an API.
...
- [X] How can we partition our application into sub-applications?
        ...
        By calling a sub-app on the mount point.
