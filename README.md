...
A:  Middleware and Routeing are two parts of express.


- [x] Describe Middleware?


A: Middleware are functions that can get the request and response of objects, operate on them and trigger an action.
...
A: A resource is data or information that Node can manipulate via the tools available.
...
A: A get request that responds with a code 200.


- [x] How can we partition our application into sub-applications?


A:  By using 'module.exports = module' and the require method.
