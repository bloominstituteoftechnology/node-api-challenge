...
- [X] Describe Middleware?
          middleware is simply a function and when executed properly with in the server, 
- [X] Describe a Resource?
          any kind of image or component
- [X] What can the API return to help clients know if a request was successful?
          if you get a (200) you know the api is running smoothly, if you get (500)or (400) we have a issue
- [X] How can we partition our application into sub-applications?
          breaking apart or partition our endpoints through the router files....because one router may do with actions whereas another router may deal with steps and yet another router could handle goals etc
