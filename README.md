...
- [ ] Describe Middleware?
A function that catchs data to put through backend. Used for autheifaction and many other areas of the backend. 

- [ ] Describe a Resource?
Data base that contains info

- [ ] What can the API return to help clients know if a request was successful?
return a status that can have a message showing the succes or error

- [ ] How can we partition our application into sub-applications?
Use routers, breaking our application into multiple files making it easier to read. 
