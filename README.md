...
- [x] Mention two parts of Express that you learned about this week.
    - We learned about server side routing with Express and Express middleware. 

- [x] Describe Middleware?
   -  Middleware are functions that extend the functionality of software.It is the biggest feature of Express and most of our code is middleware.

- [x] Describe a Resource?
    - Resources are things our app cares about- hardware or software available to our computer. They are the nouns in the app domain. 

- [x] What can the API return to help clients know if a request was successful?
    - A success message in json. Also returns a Promise, not sure which you are going for.

- [x] How can we partition our application into sub-applications?
    Using express Router and breaking up our app in different components (routers and subroutes). 
