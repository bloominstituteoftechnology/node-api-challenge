...
- [ ] Mention two parts of Express that you learned about this week.
    I learned what middleware is and how it works and I learned what express does.
- [ ] Describe Middleware?
    Middleware is a callback function that when invokes runs before other functions are invoked.
- [ ] Describe a Resource?
    A resource is a system to help keep your API neat and easy.
- [ ] What can the API return to help clients know if a request was successful?
    It can return a status like 500, 200, 404, etc with a message.
- [ ] How can we partition our application into sub-applications?
    By making clean and organized routes.
