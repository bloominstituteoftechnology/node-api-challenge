...
- [ ] Mention two parts of Express that you learned about this week.
    Middleware and request handler functions.

- [ ] Describe Middleware?
    Middleware is the software between the application and the operating system.

- [ ] Describe a Resource?
    Resources are objectives that define actions. 

- [ ] What can the API return to help clients know if a request was successful?
    API returns code.

- [ ] How can we partition our application into sub-applications?
    We can partition by using express subapp and express router.
