...
- [ ] Mention two parts of Express that you learned about this week.
  ...
  -Express lets you connect CRUD operations through its router function
  -It helps clean up the server.js file

- [ ] Describe Middleware?

  -Middleware helps make code more DRY and is a function you can integrate in a CRUD operation and use over and over again.

- [ ] Describe a Resource?

  -It is a group of data that is contained within the database, usually with its own ID.

- [ ] What can the API return to help clients know if a request was successful?

  -200 request number and a success message

- [ ] How can we partition our application into sub-applications?

  -We can break up the app with ease using routes.
