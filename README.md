...
- [x] Mention two parts of Express that you learned about this week.
    ...
    Routing different paths for different components such as posts, and comments associated with that post.

- [x] Describe Middleware?

    Software that takes in an information and manipulate it and return new information.
...
- [x] What can the API return to help clients know if a request was successful?
    ...
    By returning status codes.

- [x] How can we partition our application into sub-applications?

    By routing our components, and creating new files.
