...
- [x] Describe Middleware?
    Middleware functions give you access to the request and response object and the next function in the application’s request-response cycle.
- [x] Describe a Resource?
    Everything is a resource, unique URL, http methods ect.
- [x] What can the API return to help clients know if a request was successful?
    res.status(200).json({message:"Sucess!"})
- [x] How can we partition our application into sub-applications?
    We can compartmentalize our code as we would in react, breaking our code into smaller more manageble parts.
